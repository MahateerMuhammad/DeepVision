export default function Stepper({ value, onChange, min = 1, max = 12, className = "" }) {
  const btn =
    "flex h-7 w-7 items-center justify-center text-sm text-ink-soft transition-colors duration-150 " +
  ...
  return (
    ...
    >
      ...
      <span className="mono-num flex w-8 items-center justify-center border-x border-line text-xs font-medium">
        {value}
      </span>
      <button
        type="button"
